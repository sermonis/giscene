...
THREEx.ColliderBox3.prototype.update = function ( updateMode ) {
	...
	if ( updateMode === 'vertices' ) {
		...
		// Full recomputation of the box3 for each vertice,
		// of geometry, of each child - it is quite expensive.
		...
		/**
		 * May be useful if the object3d never moves - thus you
		 * do a collider.update( 'vertices' ) on init
		 * and collide.updateMode = 'none'; 
		 */
